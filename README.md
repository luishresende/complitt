...
| **v1 — Original CompLiTT** | *"CompLiTT: An end-to-end pipeline for processing and summarizing historical books"*, OL2A 2026 — accepted, in press | [`v1` branch](https://github.com/luishresende/complitt/tree/v1) | [Drive folder](https://drive.google.com/drive/folders/1mMKY8ry4GjUa8ofzVkv5VJKde4sF3D_A?usp=drive_link) |
